...
class PutSpoonOnTableClothInSceneGoogle(PutOnBridgeInSceneEnv):
    ...
    def get_language_instruction(self, **kwargs):
        return "put the spoon on the towel google"
...
@register_env("PutCarrotOnRamekinInScene-v2", max_episode_steps=60)
class PutCarrotOnRamekinInScene(PutOnBridgeInSceneEnv, CustomBridgeObjectsInSceneEnvV1):
    def __init__(self, **kwargs):
        source_obj_name = "bridge_carrot_generated_modified"
        target_obj_name = "ramekin"
    ...
    def evaluate(self, *args, **kwargs):
        return super().evaluate(success_include_src_in_target=True, *args, **kwargs)

    def get_language_instruction(self, **kwargs):
        return "put carrot on ramekin"


@register_env("PutCokeCanOnRamekinInScene-v2", max_episode_steps=60)
class PutCokeCanOnRamekinInScene(PutOnBridgeInSceneEnv, CustomBridgeObjectsInSceneEnvV1):
    def __init__(self, **kwargs):
    ...
    def get_language_instruction(self, **kwargs):
        return "put coke can on ramekin"


@register_env("PutGreenCubeOnPlateInScene-v2", max_episode_steps=60)
class PutGreenCubeOnPlateInScene(PutOnBridgeInSceneEnv, CustomBridgeObjectsInSceneEnvV1):
    def __init__(self, **kwargs):
        source_obj_name = "baked_green_cube_3cm"
        target_obj_name = "bridge_plate_objaverse_larger"
...
class PutCokeCanOnPlateInScene(PutOnBridgeInSceneEnv, CustomBridgeObjectsInSceneEnvV1):
    def __init__(self, **kwargs):
        source_obj_name = "coke_can"
        target_obj_name = "bridge_plate_objaverse_larger"
...
class PutPepsiCanOnPlateInScene(PutOnBridgeInSceneEnv, CustomBridgeObjectsInSceneEnvV1):
    def __init__(self, **kwargs):
...
@register_env("PutOrangeJuiceOnPlateInScene-v2", max_episode_steps=60)
class PutOrangeJuiceOnPlateInScene(PutOnBridgeInSceneEnv, CustomBridgeObjectsInSceneEnvV1):
    def __init__(self, **kwargs):
        source_obj_name = "orange_juice"
        target_obj_name = "bridge_plate_objaverse_larger"
        ...
        quat_configs = [
            np.array(
                [
                    euler2quat(np.pi/2, 0, 0),  # upright orange juice
                    [1, 0, 0, 0]
                ]
            ),
            np.array(
                [
                    euler2quat(0, 0, np.pi/2),  # lay vertically orange juice
                    [1, 0, 0, 0]
                ]
            ),
        ]
    ...
    def get_language_instruction(self, **kwargs):
        return "put orange juice on plate"


@register_env("PutNutOnWheelInScene-v2", max_episode_steps=60)
class PutNutOnWheelInScene(PutOnBridgeInSceneEnv, CustomBridgeObjectsInSceneEnvV1):
    def __init__(self, **kwargs):
        source_obj_name = "nut"
    ...
    def evaluate(self, *args, **kwargs):
        return super().evaluate(success_include_src_in_target=True, z_flag_required_offset=0.001, *args, **kwargs)

    def get_language_instruction(self, **kwargs):
        return "put nut on wheel"
